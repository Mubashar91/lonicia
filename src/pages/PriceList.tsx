 ...
 const pricingData = [
  ...
  // Laser Hair Removal (Men, Women)
  {
    ...
    services: [
      ...
      { name: 'Package 1 (Full Legs, Arms, Chest, Glutes)', price: '€120' },
      { name: 'Package 2 (Chest, Back, Armpits, Abdominal)', price: '€100' },
      { name: 'Package 3 (Full Legs, Arms, Armpits)', price: '€100' },
      { name: 'Package 4 (6 Full Body visits)', price: '€750' },
      { name: 'Package 5 (4 Full Body visits)', price: '€500' },
    ],
  },
  {
    category: 'LASER HAIR REMOVAL',
    ...
    services: [
      ...
      { name: 'Package 1 (Lower Legs, Bikini, Armpits)', price: '€80' },
      { name: 'Package 2 (Full Legs, Arms, Bikini, Armpits)', price: '€100' },
      { name: 'Package 3 (Armpits + two small areas)', price: '€40' },
      { name: 'Package 4 (6 Full Body visits)', price: '€630' },
      { name: 'Package 5 (4 Full Body visits)', price: '€420' },
    ],
  },
